...
\begin{description}
 \item[Capillary number choice] Blah-blah
 \item[Film thickness] You choose film thickness. 
 \item[Grid choice]
 \item[Body force] Blah-blah
\end{description}
...
lattice units are related to the interface resolution.  Therefore, the channel
  width is $200$ lattice units and the grid size is $200 \times 3000$.
