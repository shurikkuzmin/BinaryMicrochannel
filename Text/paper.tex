...
the interface using continuous interface methods where the interfaces spans several grid nodes.
...
Bretherton/Taylor problem using the binary liquid lattice Boltzmann method. To obtain correlations
